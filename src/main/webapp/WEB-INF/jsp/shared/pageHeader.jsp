...
<div class="header navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="header-inner">
     ...
     <ul class="nav navbar-nav pull-right">
        <a class="nav navbar-nav traffic" ><spring:message code="visit_all" /></a><a id="allCount" class="nav navbar-nav" ></a>
        <a href="<spring:message code="helpPage" />" target="_blank" class="nav navbar-nav help" ><spring:message code="help_html" /></a>
       <!--  <li class="devider">&nbsp;</li> -->
