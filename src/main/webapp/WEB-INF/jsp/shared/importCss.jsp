    ...
    <link href="<c:url value='/plugins/bootstrap2/css/bootstrap.css'/>" rel="stylesheet" type="text/css"/>
    ...
    <link href="<c:url value='/css/validform.css'/>" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
    <link rel="SHORTCUT ICON" href="<c:url value='/images/header/favicon.ico'/>"> 
    <link rel="BOOKMARK" href="<c:url value='/images/header/favicon.ico'/>"> 
