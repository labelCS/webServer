...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu">
        ...
        <c:choose>
            <c:when test="${auth eq 'root'}">
                ...
                <c:choose>  
                    ...
                    <ul class="sub-menu">
                        <c:if test = "${fn:contains(menu,'key_storeManage') or fn:contains(menu,'all') }" >
                            <c:choose>  
                        ...
                        <!--sva管理 -->
                        <c:if test = "${fn:contains(menu,'key_svaManage') or fn:contains(menu,'all') }" >
                            <c:choose>
                                <c:when test="${svaMng}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_mapManage') or fn:contains(menu,'all') }" >
                            <c:choose>  
                                <c:when test="${mapMng}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_messagePush') or fn:contains(menu,'all') }" >
                            <c:choose>  
                                <c:when test="${msgMng}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <%-- <c:if test = "${fn:contains(menu,'key_sellerInfo') or fn:contains(menu,'all') }" >
                            <c:choose>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_areaCategory') or fn:contains(menu,'all') }" >
                            <c:choose>
                        ...
                        <c:if test = "${fn:contains(menu,'key_areaInfo') or fn:contains(menu,'all') }" >
                            <c:choose>  
                        ...
                        <a href="<c:url value='/home/pet' />">
                            <i class="round" style="background-color: #159FE4;"></i>
                            <span><spring:message code="pet_infomation" /></span>
                        </a>
                        </li>                                             
                        <c:choose>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_role') or fn:contains(menu,'all') }" >
                            <c:choose>
                                <c:when test="${role}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_account') or fn:contains(menu,'all') }" >   
                            <c:choose>
                                <c:when test="${account}">  
                                    <li class="active">
                                </c:when>
        ...
        <c:choose>
            <c:when test="${auth eq 'root'}"> 
                ...
                <ul class="sub-menu">
                    ...
                    <c:if test = "${fn:contains(menu,'key_customerPeriodHeamap') or fn:contains(menu,'all') }" >
                        <c:choose>
                    ...
                    <c:if test = "${fn:contains(menu,'key_customerScattermap') or fn:contains(menu,'all') }" >
                        <c:choose>  
               ...
               <!--     <c:if test = "${fn:contains(menu,'key_historicalTrack') or fn:contains(menu,'all') }" >
                        <c:choose>  
                            <c:when test="${follow}">  
                                <li class="active">
                            </c:when>  
                    ...
                    <c:if test = "${fn:contains(menu,'key_CustomerFlowLinemap') or fn:contains(menu,'all') }" >
                        <c:choose>  
                            <c:when test="${linemap}">  
                                <li class="active">
                            </c:when>  
                    ...
                    <c:if test = "${fn:contains(menu,'key_positionMap') or fn:contains(menu,'all') }" >
                        <c:choose>  
                    ...
                    <!--  
                    <c:if test = "${fn:contains(menu,'key_CustomerFlowRangeLinemap') or fn:contains(menu,'all') }" >
                        <c:choose>  
                            <c:when test="${barmap}">  
                                <li class="active">
                            </c:when>  
                    ...
                    <c:if test = "${fn:contains(menu,'key_areaLocation') or fn:contains(menu,'all') }" >
                        <c:choose>  
                            <c:when test="${areamap}"> 
                                <li class="active">
                            </c:when>
        ...
        <c:choose>
            <c:when test="${auth eq 'root'}">
            <c:if test = "${fn:contains(menu,'key_code') or fn:contains(menu,'all') or fn:contains(menu,'key_staticAccuyacy') or fn:contains(menu,'key_estimateDeviation') or fn:contains(menu,'key_dynamicAccuyacy') or fn:contains(menu,'key_positionlatency') or fn:contains(menu,'key_MessagePush') }" >
                <c:choose>  
                    <c:when test="${locTest}">  
                        <li class="active open">
                        <a href="javascript:;"> 
                    ...
                    <ul class="sub-menu">
                        <c:if test = "${fn:contains(menu,'key_code') or fn:contains(menu,'all') }" >
                            <c:choose>  
                                <c:when test="${codeMng}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_estimateDeviation') or fn:contains(menu,'all') }">  
                            <c:choose>  
                    ...
                    <!--    <c:if test = "${fn:contains(menu,'key_summaryDisplay') or fn:contains(menu,'all') }">
                            <c:choose>  
                     ...
                     -->    
                        <c:if test = "${fn:contains(menu,'key_staticAccuyacy') or fn:contains(menu,'all') }" >
                            <c:choose>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_dynamicAccuyacy') or fn:contains(menu,'all') }" >
                            <c:choose>  
                        ...
                        <c:if test="${fn:contains(menu,'key_positionlatency') or fn:contains(menu,'all') }">
                            <c:choose>  
    ...
    <c:if test="${fn:contains(menu,'key_bluemixConnection') or fn:contains(menu,'all') or fn:contains(menu,'key_ping') or fn:contains(menu,'key_pRRUConfig') or fn:contains(menu,'key_paramConfig') or fn:contains(menu,'key_versionDownload') or fn:contains(menu,'key_APKDownload') }">
        <c:choose>
            <c:when test="${tools}">  
                <li class="start active open">
	                <a href="javascript:;"> 
	                	<img src="<c:url value='/images/header/navicon4.png'/>">
	                	<span class="toggleMenuTxt"><spring:message code="menu_tools" /></span>
	                	<span class="arrow open"></span>
	                </a>
            </c:when>  
            <c:otherwise>  
            ...
            <ul class="sub-menu">
                <c:choose>
                    <c:when test="${auth eq 'root'}">
                        <c:if test = "${fn:contains(menu,'key_pathPlan') or fn:contains(menu,'all') }" >
                        <c:choose>
                            <c:when test="${pathPlan}">
                                <li class="active">
                            </c:when>
                            <c:otherwise>
                                <li class="">
                        ...
                        <a href="<c:url value='/home/showPathPlan' />">
                            <i class="round" style="background-color: #E64C66;"></i>
                            <span><spring:message code="menu_tools_pathPlan" /></span>
                        </a>
                        </li>
                    </c:if>
                    </c:when>
                 ...
                 <c:choose>
                    <c:when test="${auth eq 'root'}">
                        <c:if test = "${fn:contains(menu,'key_bluemixConnection') or fn:contains(menu,'all') }" >
                        <c:choose>
                            <c:when test="${bluemix}">
                                <li class="active">
                            </c:when>
                ...
                <c:choose>
                    <c:when test="${auth eq 'root'}">
                        <c:if test = "${fn:contains(menu,'key_ping') or fn:contains(menu,'all') }" >
                            <c:choose>  
                                <c:when test="${ping}">  
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_pRRUConfig') or fn:contains(menu,'all') }" >    
                            <c:choose>
                                <c:when test="${pRRU}">  
                                    <li class="active">
                                </c:when>
                        ...
                        <c:if test = "${fn:contains(menu,'key_paramConfig') or fn:contains(menu,'all') }" >
                            <c:choose>
                        ...
                        <!--
                        <c:if test = "${fn:contains(menu,'key_versionDownload') or fn:contains(menu,'all') }" >
                            <c:choose>
                                <c:when test="${down}">
                                    <li class="active">
                                </c:when>  
                        ...
                        <c:if test = "${fn:contains(menu,'key_APKDownload') or fn:contains(menu,'all') }" >
                            <c:choose>
                                <c:when test="${qrcode}">  
                                    <li class="active">
                                </c:when>  
       	...
       	<c:choose>
            <c:when test="${allcontent}">  
                <li class="start active open">
                	<a href="javascript:;"> 
                		<img src="<c:url value='/images/bz.png'/>">
                		<span class="toggleMenuTxt"><spring:message code="judian_yanshi" /></span>
                		<span class="arrow open"></span>
                	</a>
            </c:when>  
            <c:otherwise>  
