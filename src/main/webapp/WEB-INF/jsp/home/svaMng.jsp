             				...
             				<div class="row-fluid">
              					<div class="span12" style="outline:0px solid #E6E4E4;padding:20px 0;">
                   					...
                   					<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" datatype="number"  errormsg='<spring:message code="sva_port_tishi" />'   nullmsg='<spring:message code="sva_token" />' style="width: 56%;height: 15%" class="input-xlarge" name="tokenPort" id="tokenId" maxlength="20" reg="^.{0,20}$" placeholder="<spring:message code="sva_token" />">
                                        </div>
                                    </div>
                                    <div class="control-group">
...
<div><button style="height: 30px;" type="button" class="btn btn-primary" onclick="addMap()"><spring:message code="common_add" /></button></div>                    			
<!-- 
