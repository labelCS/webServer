...
<body class="page-header-fixed">
			...
			<div>
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><spring:message code="menu_location_result" /></li>
					</ul>
				...
				<table id="table" class="table table-bordered">
					<thead>
						<tr>
							...
							<th><spring:message code="test_table_title_type" /></th>
							<th><spring:message code="test_table_title_offset" /></th>
	...
	<script src="<c:url value='/js/accuracy.js'/>" type="text/javascript"></script>
