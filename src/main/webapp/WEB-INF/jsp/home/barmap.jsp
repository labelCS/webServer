...
<body class="page-header-fixed">
			...
			<div>
				<div>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><spring:message code="menu_customer_analyse_barmap" /></li>
					</ul>
			...
			<form class="demoform">
				...
				<div class="span6">
					<div class="input-append">
						...
						<span class="add-on" onclick="Barmap.showDate('select_time_begin_tab1');">
					...
					<div class="input-append">
						...
						<span class="add-on" onclick="Barmap.showDate('select_time_end_tab1');"> 
							<i class="icon-calendar"></i>
						</span>
					</div>
				</div>
			...
			<div class="chartArea hide">
				...
				<div class="infoArea">
					...
					<div class="infoBox fleft">
						...
						<div class="infoTop"><spring:message code="barmap_info_total" /></div>
					...
					<div class="infoBox">
						...
						<div class="infoTop"><spring:message code="barmap_info_maxFloor" /></div>
					...
					<div class="infoBox fright">
						...
						<div class="infoTop"><spring:message code="barmap_info_minFloor" /></div>
	...
	<script src="<c:url value='/js/barmap.js'/>" type="text/javascript"></script>
