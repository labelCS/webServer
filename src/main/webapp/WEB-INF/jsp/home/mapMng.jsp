								...
								<div class="row-fluid">
									<div class="span12"
										...
										<div class="control-group">
											...
											<div class="controls">
												<input  type="text" maxlength="20"  datatype="all"  nullmsg='<spring:message code="map_place_name" />' style="width: 56%; height: 15%;"
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="coorSel"><spring:message
                                                    code="map_type" /></label>
                                            <div class="controls">
                                                <select style="width: 58%; height: 15%;" datatype="*" name="mapType"
                                                    id="mapTypeId">
                                                    <option value="0">
                                                    </option>                                                    
                                                    <option value="2">
                                                        <spring:message code="map_store" />
                                                    </option>
                                                    <option value="1">
                                                        <spring:message code="map_car" />
                                                    </option>                                                    
                                                </select>
                                            </div>
                                        </div>                                        										
												...
												<div class="control-group">
													...
													<div class="controls" style="margin-left:140px;">
														<input type="text" style="width: 60%; height: 15%" datatype="n3" errormsg='<spring:message code="map_zuobiaox" />'  nullmsg='<spring:message code="map_x" />'
															maxlength="10" class="input-xlarge" name="xo" id="xId"
												...
												<div class="control-group" style="margin-bottom: 10px;">
													...
													<div class="controls" style="margin-left:140px;">
														<input type="text" style="width: 60%; height: 15%"
															maxlength="10" class="input-xlarge" name="yo" id="yId" datatype="n3" errormsg='<spring:message code="map_zuobiaoy" />'  nullmsg='<spring:message code="map_y" />'
															 onkeyup="estimateOnkeyup(this)" />
													</div>
												</div>
											</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
	            ...
	            validForm = $(".demoform").Validform({tiptype:3,
					datatype:{
						"sn":function(gets,obj,curform,regxp){
							if (gets!="") {
							 var geshi = /^(-|\+)?\d+$/;
							 return geshi.test(gets);
							}
						},
