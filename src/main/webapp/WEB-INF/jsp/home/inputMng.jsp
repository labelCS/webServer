	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="tableBox">
								...
								<div class="row-fluid">
									<div class="span12" style="outline:0px solid #E6E4E4;padding:20px 0;">
										<div class="control-group">
											...
											<div class="controls">
												<select datatype="*"  nullmsg='<spring:message code="map_store_name" />' style="width: 59%;height: 15%;" name="store.id" id="placeSel" >
													<option value=""></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select datatype="*"  nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;" name="maps.floorNo" id="zSel" >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select datatype="*"  nullmsg='<spring:message code="area_RegionalCategory" />'  style="width: 59%;height: 15%;" name="category.id" id="category" >
													<option value=" "></option>
												</select>
											</div>
										</div>
				...
				<div>
					<button id="add" type="button" class="btn btn-primary" onclick="addMap()"><spring:message code="common_add" /></button>
		...
		<!-- BEGIN FOOTER -->
       	...
       	<div class="modal hide fade" data-backdrop="static" id="myModal1">
			...
			<div class="modal-footer">
				...
				<button id="Ok" data-dismiss="modal"  aria-hidden="true" disabled="disabled"  class="btn"><spring:message code="common_confirm" /></button>
			</div>
		</div>
