...
<body class="page-header-fixed">
			...
			<div>
				<div>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><spring:message code="category_Regional" /></li>
					</ul>
			...
			<div class="tableBox">
							...
							<div class="span12" style="outline:0px solid #E6E4E4;padding:20px 0;">
								<div class="control-group">
									<label class="control-label" for="categoryName">
										<spring:message code="category_category" />
									</label>
									<div class="controls">
										<input type="text" maxlength="20" nullmsg="<spring:message code="category_inputCategoryName" />"  datatype="password" errormsg="<spring:message code="store_name_length" />"   style="width: 56%;height: 15%" class="input-xlarge" id="categoryName">
				...
				<table id="table" class="table table-bordered">
					<thead>
						<tr>
							<th></th>
							<th style="min-width:100px;height: 20px"><spring:message code="category_category" /></th>
	...
	<script src="<c:url value='/js/categoryMng.js'/>" type="text/javascript"></script>  
	...
	<script type="text/javascript">
		...
		var i18n_edit = '<spring:message code="common_edit" />',
			...
			i18n_storeinput = '<spring:message code="category_inputCategoryName" />';
