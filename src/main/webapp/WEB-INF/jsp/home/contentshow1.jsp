...
<head>
	...
	.row-fluid .span6 .row-fluid .span12{
		outline:0px solid #E6E4E4;
		padding:20px 0;
	}
	</style>
</head>
...
<body id="body" class="page-header-fixed">
			...
			<div>
				<div>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><spring:message code="bz_zhanshicanshu" /></li>
					</ul>
						...
						<div class="row-fluid">
								...
								<div class="row-fluid">
									<div class="span12">
										<div class="control-group">
											<label class="control-label" for=placeSel><spring:message code="bz_store1" /></label>
											<div class="controls">
												<select datatype="xzsc" id="placeSel" nullmsg='<spring:message code="map_store_name" />' style="width: 59%;height: 15%;"   >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<select datatype="xzsc" id="zSel" nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;"  >
													<option value=" "></option>
												</select>
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for=placeSel><spring:message code="bz_store2" /></label>
											<div class="controls">
												<select datatype="xzsc"  id="placeSel2"  nullmsg='<spring:message code="map_store_name2" />' style="width: 59%;height: 15%;" >
												    <option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="zSel"><spring:message code="message_table_title_floor" /></label>
											<div class="controls">
												<select datatype="xzsc" id="zSel2"  nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;"  >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for=placeSel><spring:message code="bz_store21" /></label>
											<div class="controls">
												<select datatype="xzsc"  id="placeSel2Sp"  nullmsg='<spring:message code="map_store_name21" />' style="width: 59%;height: 15%;" >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="zSel"><spring:message code="message_table_title_floor" /></label>
											<div class="controls">
												<select datatype="xzsc" id="zSel2Sp"  nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;"  >
													<option value=" "></option>
												</select>
											</div>
										</div>
							...
							<div class="span6">
                  				<div class="row-fluid">
                      				<div class="span12">	
										<div class="control-group">
											<label class="control-label" for=placeSel><spring:message code="bz_store3" /></label>
											<div class="controls">
												<select datatype="xzsc" id="placeSel3" nullmsg='<spring:message code="map_store_name3" />' style="width: 59%;height: 15%;"   >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="zSel"><spring:message code="message_table_title_floor" /></label>
											<div class="controls">
												<select datatype="xzsc" id="zSel3" nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;"   >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for=placeSel><spring:message code="bz_store31" /></label>
											<div class="controls">
												<select datatype="xzsc" id="placeSel3Sp" nullmsg='<spring:message code="map_store_name31" />' style="width: 59%;height: 15%;"   >
													<option value=" "></option>
												</select>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="zSel"><spring:message code="message_table_title_floor" /></label>
											<div class="controls">
												<select datatype="xzsc" id="zSel3Sp" nullmsg='<spring:message code="all_floor_choose" />'  style="width: 59%;height: 15%;"   >
													<option value=" "></option>
												</select>
											</div>
										</div>
   ...
   <%@ include file="../shared/pageFooter.jsp"%>
		...
		<script src="<c:url value='/js/contentshow1.js'/>" type="text/javascript"></script>
