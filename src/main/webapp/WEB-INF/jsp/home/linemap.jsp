...
<style>
	.demoform .span3 select{
		width: 100%;
		height:26px;
		padding:2px 0 2px 0;
	}
	.demoform .span6 input{
		width: 180px;
	}
	.row-fluid{
			...
			<form class="demoform">
				...
				<div class="span6">
					<div class="input-append">
						<input id="select_time_begin_tab1" datatype="*"  nullmsg='<spring:message code="all_choose_starttime" />' readonly/> 
					...
					-
					<div class="input-append">
						<input id="select_time_end_tab1" datatype="*"  nullmsg='<spring:message code="all_choose_endtime" />' readonly/> 
				...
				<div class="span1">
					<input type="button" value="<spring:message code="common_confirm" />" id="confirm" style="vertical-align: top; margin-top: 0;">
				</div>
