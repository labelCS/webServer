		...
		<div class="page-content">
			...
			<form class="demoform" onkeydown= "if(event.keyCode==13)return false;">
				<select id="marketSel" datatype="*"  nullmsg='<spring:message code="map_store_name" />' 
					...
					style="width: 30%" >
					<option value=""></option>
				</select> <select id="floorSel" datatype="*"  nullmsg='<spring:message code="all_floor_choose" />' name="floorSelName"
					data-placeholder="<spring:message code="heatmap_floor" />"
					style="width: 30%" class="chosen-select">
					<option value=""></option>
				</select>
				<input type="text" id="time" datatype="zs" maxlength="8" errormsg="<spring:message code="heatmap_integer" />"  nullmsg='<spring:message code="heatmap_time" />' value="10"  placeholder="time">
				<input id="confirm" type="button" value="<spring:message code="common_confirm" />">
				<div class="pull-right">
					<select id="densitySel"
						data-placeholder="<spring:message code="heatmap_density" />"
						class="chosen-select">
					...
					</select> <select id="radiusSel"
						data-placeholder="<spring:message code="heatmap_diffusance" />"
						class="chosen-select">
						<option value="-1"></option>
						<option value="20">20</option>
				...
				<div id="divCon" style="text-align: center; height: 600px;">
					<div id="mapContainer" class="demo-wrapper">
						...
						<div id="legend" class="legend-area hide">
							...
							<!-- <div style="float:left;margin:0 5px;padding:1.5px 0;"><img id="gradient" src="" style="width: 100%;border-radius:5px;" /></div> -->
			</div>
