			...
			<div>
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><spring:message code="static_menu" /></li>
					</ul>
				...
				<div class="span4 offset1 popuptext">
					<table class="table table-bordered table-striped">
						...
						<tr>
			                ...
			                <td><label id="staicAccuracy"></label></td>
			            </tr>
						<tr>
			                <td>
			                  	<spring:message code="static_offsetcenter_title" />
			                </td>
			                <td><label id="offsetCenter"></label></td>
			            </tr>
						<tr>
			                <td>
			                  	<spring:message code="static_offsetnumber_title" />
			                </td>
			                <td><label id="offsetNumber"></label></td>
			            </tr>
						<tr>
			                <td>
			                  	<spring:message code="static_stability_title" />
			                </td>
			                <td><label id="stability"></label></td>
			            </tr>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("a[data-type='detail']").live('click', function(e) {
				...
				setTimeout(function(){staticAccuracy.initPopupChart(data);},500);
