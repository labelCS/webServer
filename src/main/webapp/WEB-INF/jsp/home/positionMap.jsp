				...
				<form class="demoform" onkeydown= "if(event.keyCode==13)return false;">
					...
					<div class="span4">
						<div class="input-append">
							<input id="select_time_begin_tab" style="width: 180px; height: 22px;" readonly/> 
						...
						-
						<div class="input-append">
							<input id="select_time_end_tab" style="width: 180px; height: 22px;" readonly/> 
					...
					<div class="span4">
						...
						style="vertical-align: bottom; padding: 3px 5px; height: 27px; line-height: 18px;" value="<spring:message code="common_confirm" />">
