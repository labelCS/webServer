...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<form class="demoform">
         	...
         	<input id="confirm" type="button" value="<spring:message code="common_confirm" />" style="vertical-align:top;padding: 2px 5px;height: 27px">
		</form>
		</div>
		<div id="mainContent" class="row-fluid hide">
			...
			<div id="divCon" style="text-align:center;height:600px;">
	            <div id="mapContainer" style="position:relative;">
			    	<div id="scattermap" class="heatmap"></div>
			    </div>
		    </div> 
         </div>
   ...
   var pointVal = 20;
      ...
      jQuery(document).ready(function() { 
    	 ...
    	 App.init();
    	 ScattermapPage.initDropdown();
    	 ScattermapPage.bindClickEvent();
    	 //Heatmap.initHeatmap();
      });
   </script>
   <!-- END JAVASCRIPTS -->
