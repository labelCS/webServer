                    ...
                    <table id="table" class="table table-bordered" style="text-align:center">
                        <thead>
                            <tr>
                                ...
                                <th style="width:60px"><spring:message code="param_filterlength" /></th>
                                <th style="width:60px"><spring:message code="param_horizontal" /></th>
                                <th style="width:60px"><spring:message code="param_ongitudinal" /></th>
                                <th style="width:60px"><spring:message code="param_maxDeviation" /></th>
                                <th style="width:80px"><spring:message code="param_exceedMaxDeviation" /></th>
                                <th style="width:80px"><spring:message code="param_correMap" /></th>
                                <th style="width:60px"><spring:message code="param_resTime" /></th>
                                <th style="width:80px"><spring:message code="param_filterPeak" /></th>
                                <th style="width:60px"><spring:message code="param_peakWidth" /></th>
                                <th style="width:50px"><spring:message code="param_step" /></th>
                                <th style="width:120px"><spring:message code="bluemix_updateTime" /></th>                                
                                <th style="width:70px"><spring:message code="message_table_title_operation" /></th>
                            </tr>
                        </thead>            
                    </table>    
                </div>
