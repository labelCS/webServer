...
//        						"bVisible": false,
        					...
        					},
        					{
        	                    ...
        	                    "mRender": function ( data, type, full ) {
        	                    	var html = "" +
        	                    		'<input type="button" style="width: 53px;height:30px;font-size: 13px;font-family:inherit;" data-type="fuzhi" data-mapType="'+full.mapType+'" data-id="'+full.floorid+'" value="'+i18n_fuzhi+'">' +
