...
//        						"bVisible": false,
        					...
        					},
        					{
        	                    ...
        	                    "mRender": function ( data, type, full ) {
									...
									{
										htm11 = '<input type="button" style="width: 63px;height:30px;font-size: 13px;font-family:inherit;" data-type="undingyue" data-placeid="'+full.store.id+'" data-categoryid="'+full.categoryId+'" id="'+full.area.id+'" data-id="'+full.area.id+'" value="'+i18n_undingyue+'">' ;
									}
        	                    	var html = "" +
        	                    		htm11 + 
