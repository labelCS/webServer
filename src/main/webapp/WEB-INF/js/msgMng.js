...
//            						"bVisible": false,
            					...
            					},
            					{
            	                    ...
            	                    "mRender": function ( data, type, full ) {
            	                    	var html = "" +
            	                    		'<input type="button" data-type="ticketEdt" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-placeid="'+full.placeId+'" data-shopId="'+full.msg.id+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" data-floorno="'+full.floorNo+'" value="'+i18n_edit+'" id="'+full.id+' ">' +
            	                    		'<input type="button" data-type="ticketDel" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-floorNo="'+full.floorNo+'" data-shopId="'+full.msg.id+'" id="'+full.id+'" data-id="'+full.id+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" value="'+i18n_delete+'">';
            	                        return html;
            	                      }
            	                }
            				],
