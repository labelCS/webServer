...
public interface AreaDao {
    ...
    public int getNumberByTime(@Param("mapId")int mapId, @Param("tableName")String tableName);

    public int getYesterdayNumber(@Param("mapId")int mapId, @Param("tableName")String tableName, 
    ...
    public List<String> getAllBaShowVisitUser(@Param("mapId")String mapId, @Param("tableName")String tableName,
            @Param("time")String time);

    public List<String> getUserByFloorNo(@Param("mapId")String mapId, @Param("tableName")String tableName,
            @Param("time")String time);
    ...
    public List<Long> getBaShowAllVisitTimes(@Param("mapId")String mapId, @Param("userId")String userId,
            @Param("tableName")String tablename, @Param("time")String time);
    ...
    public int svaeBaShowByAllAeare(@Param("mapId")String mapId, @Param("time")String time, 
            @Param("allTime")Long allTime, @Param("number")int number, @Param("averageTime")String averageTime);
    ...
    public List<Map<String, Object>> getAllAverageTimeByAreaId(@Param("mapId")String mapId,
            @Param("time")String time);

    public List<Map<String, Object>> getOverAverageTime(@Param("areaId")String areaId, @Param("time")String time);

    public List<Map<String, Object>> getBaShowAllData(@Param("mapId")String mapId,
    ...
    public int getAllPeoples(@Param("mapId")String mapId, @Param("tableName")String tableName, 
...
//    public int getAllArea(String areaId);
    ...
    public List<Map<String, Object>> getAllAverageTimeByAreaId2(@Param("mapId")String mapId,
