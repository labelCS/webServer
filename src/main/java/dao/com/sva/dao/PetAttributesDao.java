...
public interface PetAttributesDao {
    ...
    public String getPetProbabilityByPetName(@Param("petName")String petName);
    
    public List<PetAttributesModel> getPetByUserName(@Param("userName")String userName);
    
    public int saveTicketData(TicketModel pet);
    
    public List<TicketModel> getTicketByUserName(@Param("userName")String userName);
}