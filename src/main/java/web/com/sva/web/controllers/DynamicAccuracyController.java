...
public class DynamicAccuracyController
{
            ...
            @RequestBody AccuracyTableModel atm)
    {
        ...
        Collection<DynamicAccuracyModel> res = new ArrayList<DynamicAccuracyModel>(10);
        Collection<DynamicAccuracyModel> store;
            ...
            @RequestParam("endTime") String endTime)
    {
        ...
        Map<String, Object> modelMap = Util.getCDFDynamicAccuracy(listName, res,total);
            ...
            HttpServletResponse response)
    {
        ...
        {
            // 1,得到所有的精度汇总信息
            List<DynamicAccuracyModel> summaryInformation = dao.allQueryDynamicAccuracy();
            ...
            DynamicAccuracyModel dynamicAccuracyModel;
            ...
            DynamicAccuracyModel dynamicAccuracyModel, Cell detailTitle)
    {
        ...
        exportContent(contentStyle, placeTitle, row, 0,
                dynamicAccuracyModel.getStore().getName());

        // 第二行第1列赋值楼层值
        exportContent(contentStyle, floorTitle, row, 1,
                dynamicAccuracyModel.getMaps().getFloor());
        // 第二行第2列赋值坐标X米值
