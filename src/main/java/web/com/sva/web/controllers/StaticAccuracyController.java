...
{
    private static final Logger LOG = Logger.getLogger(StaticAccuracyController.class);
            ...
            @RequestBody AccuracyTableModel atm)
    {
        ...
        Collection<StaticAccuracyModel> res = new ArrayList<StaticAccuracyModel>(10);
        Collection<StaticAccuracyModel> store;
        ...
        Map<String, Object> modelMap = Util.getCDF(listName, res,total);
            ...
            HttpServletResponse response)
    {
        ...
        try
        {
            ...
            StaticAccuracyModel staticAccuracyModel;
            ...
            for (int i = 1; i < sumSize + 1; i++)
            {
                ...
                typeTitle = inputValue(typeTitle, placeTitle, floorTitle,
                        ...
                        tfiveMTitle, ftenMTitle, tenMTitle,
