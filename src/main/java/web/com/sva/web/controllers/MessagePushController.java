...
public class MessagePushController
{
    ...
    public Map<String, Object> getTableData(HttpServletRequest request)
    {
        ...
        Collection<MessagePushModel> resultList = new ArrayList<MessagePushModel>(10);
        Collection<MessagePushModel> store;
        ...
        @RequestParam("endTime") String endTime)
    {
        ...
        Collection<MessagePushModel> res = new ArrayList<MessagePushModel>(10);
        Collection<MessagePushModel> store;
        ...
        Map<String, Object> modelMap = Util.getCDFMessagePush(listName, res,total);
            ...
            HttpServletResponse response)
    {
        ...
        {
            // 1,得到所有的精度汇总信息
            List<MessagePushModel> summaryInformation = pushDao.getAllData();
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            MessagePushModel accuracyModel;
            ...
            for (int i = 1; i < sumSize + 1; i++)
            {
                ...
                typeTitle = inputValue(placeTitle, floorTitle, xTitle, yTitle,
                        ...
                        typeTitle,  averDeviTitle, titleStyle,
    ...
    private Cell inputValue(Cell placeTitle, Cell floorTitle, Cell xTitle,
            ...
            Cell triggerIpTitle, Cell typeTitle, 
            Cell averDeviTitle, CellStyle titleStyle,
