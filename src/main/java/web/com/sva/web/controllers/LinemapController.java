...
public class LinemapController
{
    ...
    {
        Map<String, Integer> map = getPeriodList(startTime, endTime,
                Integer.parseInt(dim));
        String time = startTime.split(" ")[0] + ' ' + "00:00:00";
        Collection<LinemapModel> res;
            ...
            @RequestParam("endTime") String endTime)
    {
        ...
        Collection<LinemapModel> resMaxDay = dao.getMaxDay(placeId, startTime, endTime);
        Collection<LinemapModel> resMaxHour = dao.getMaxTime(placeId, startTime, endTime);
    ...
    public static Map<String, Integer> getPeriodList(String startTime,
