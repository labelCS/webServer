...
public class AccuracyController
{
            ...
            @RequestBody AccuracyTableModel atm)
    {
        ...
        Collection<AccuracyModel> store;
            ...
            AccuracyModel accuracyModel)
    {
        ...
        // 第二行第10列赋值预估偏差值
        Cell deviationTitle = row.getCell(10);
        if (deviationTitle == null)
        {
            deviationTitle = row.createCell(10);
        }
        if (accuracyModel.getEstimate().getDeviation() == null)
        {
        ...
        {
            deviationTitle.setCellStyle(contentStyle);
            deviationTitle.setCellValue(accuracyModel.getEstimate().getDeviation().doubleValue());
        }
        // 第二行第11列赋值3m以内值
